(() => {
    ...
    document.addEventListener("click", (e => {
        let target = e.target;
        if (target.classList.contains("hamburger")) headerMobile.classList.add("open");
        if (target.classList.contains("close") || target.classList.contains("menu__link")) headerMobile.classList.remove("open");
    }));
    ...
    if (window.innerWidth > 1451.98) {
        ...
        setInterval((function() {
            i++;
            if (i == 2) users[0].classList.add("active");
            if (i == 3) users[1].classList.add("disabled");
            if (i == 5) users[2].classList.add("disabled");
            if (i == 7) {
                users[0].classList.remove("active");
                users[2].classList.remove("disabled");
                users[2].classList.add("active");
            }
            if (i == 9) users[0].classList.add("active");
            if (i == 12) {
                users[0].classList.remove("active");
        ...
        setInterval((function() {
            j++;
            if (j == 1) businessChat[0].classList.add("active");
            if (j == 4) {
            ...
            if (j == 12) businessChat[3].classList.remove("active");
            if (j == 13) j = 0;
        }), 1e3);
    }
    spollers();
